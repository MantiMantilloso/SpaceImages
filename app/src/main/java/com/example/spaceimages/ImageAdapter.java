...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String text = Integer.toString(position + 1) + ": " + data.title;

        //Numero + Nombre de la imagen
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            number = itemView.findViewById(R.id.text_title);
            url = itemView.findViewById(R.id.text_url);
            thumbnail = itemView.findViewById(R.id.image_icon);
        }
    }
}
